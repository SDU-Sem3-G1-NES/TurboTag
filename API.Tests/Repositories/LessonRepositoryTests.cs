...
public class LessonRepositoryTests
{
    ...
    public void GetLessonByObjectId_ReturnsLessonWithValidObjectId()
    {
        ...
        _mockDb.Setup(db => db.Find<LessonDto>("lesson", $"{{\"_id\": ObjectId(\"{objectId}\")}}", null, null))
            .Returns(new List<LessonDto> { lesson });
    ...
    public void GetLessonById_ReturnsLessonWithValidId()
    {
        ...
        _mockDb.Setup(db => db.Find<LessonDto>("lesson", $"{{\"lesson_details._id\": {lessonId}}}", null, null))
            .Returns(new List<LessonDto> { lesson });
    ...
    public void GetLessonById_ReturnsNullForInvalidId()
    {
        ...
        _mockDb.Setup(db => db.Find<LessonDto>("lesson", $"{{\"lesson_details._id\": {invalidLessonId}}}", null, null))
    ...
    public void GetLessonByUploadId_ReturnsLessonWithValidUploadId()
    {
        ...
        _mockDb.Setup(db => db.Find<LessonDto>("lesson", $"{{upload_id: {uploadId}}}", null, null))
            .Returns(new List<LessonDto> { lesson });
    ...
    public void GetLessonByUploadId_ReturnsNullForInvalidUploadId()
    {
        ...
        _mockDb.Setup(db => db.Find<LessonDto>("lesson", $"{{upload_id: {invalidUploadId}}}", null, null))
            .Returns(new List<LessonDto>());
